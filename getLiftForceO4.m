function [forcex,forcey]=getLiftForceO4(x,y,rsph,U, rho, L)
%% INPUT:
...
%  i.e. rsph > .2L
%
%  Code will return an error if a particle of radius rsph at location
%  (x,y) hits the wall. (i.e. rsph > .5L - max(x,y) )
%
%% AUTHOR
