...
%
%  updated to run faster by using interpolation instead of evaluating
%  getLiftForceAR1.m at each point  Uses the mat file:
%  
%
%% AUTHOR
...
alpha = rsph/H; L=1; AR = W/H; U = 1; rho=1; mu=1; dt = .01*(U0/H)*(T/N);
...
x(:,1)=r(:,1); y(:,1)=r(:,2); 
load inertial_constants_AR1_n1001_05142015.mat
for j=2:N;
    if mod(j,100) == 0
